...
\begin{enumerate}
    ...
    \item На стороне Go реализовать: фильтрацию объектов, агрегацию (подсчёт суммы/количества), кэширование часто запрашиваемых данных и проверку бизнес-правил перед отправкой данных на Python-сервер.
